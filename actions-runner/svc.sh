...
SVC_NAME="actions.runner.HelderOliveira77-SiteMultiponto-Digipress.github.io.Mac7"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (HelderOliveira77-SiteMultiponto-Digipress.github.io.Mac7)"
